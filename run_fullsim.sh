...
STDHEP_PATH="data/StdHep/FCC/"
INPUT_FILE="wzp6_ee_qqH_ecm240/events_088604297.stdhep"
NEVENTS=${1:-10}
SKIPEVTS=${2:-0}

OUTPUT_PATH="data/ILD/FullSim/"
OUTPUT_FILE="wzp6_ee_qqH_ecm240_fullSim_${SKIPEVTS}+${NEVENTS}.slcio"
...
echo ddsim --inputFiles ${STDHEP_PATH}${INPUT_FILE} --outputFile ${OUTPUT_PATH}${OUTPUT_FILE} \
