from D_histograms_library import get_histograms, get_x_titles, histograms_selections, all_histograms, write_histograms
import sys
import ROOT

file = ROOT.TFile.Open("/home/llr/ilc/hassouna/script2/CalorimeterFluxes/data/ILD/FullSim/energy_histograms/90mu/all.root")
...
dir = sys.argv[1]
write_histograms(twoD_histograms, histogram_selection_dictionary, dir, canvas)