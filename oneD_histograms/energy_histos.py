...
#       System          collections                                         Stave  Modules                Towers                        Layers                      Time bins/max lowE bin/max highE bin/max allE bin/max low# bin/max high# bin/max all# bin/max EThr  Split Func:ranges         
        "SiECalEndcap": (["ECalEndcapSiHitsEven", "ECalEndcapSiHitsOdd"],   [["*"],["*"],                 ["0","1:2","3:5","6:8"],      ["0:9","10:19","20:29"]],   [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [0.0001]], {}),
        "SiECALBarrel": (["ECalBarrelSiHitsEven", "ECalBarrelSiHitsOdd"],   [["*"],["1","2","3","4","5"], ["*"],                        ["0:9","10:19","20:29"]],   [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [0.0001]], {}), 
        "SiECalRing": (["EcalEndcapRingCollection"],                        [["*"],["*"],                 ["*"],                        ["0:9","10:19","20:29"]],   [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [0.0001]], {}), 
        "ScECalEndcap": (["ECalEndcapScHitsEven", "ECalEndcapScHitsOdd"],   [["*"],["*"],                 ["0","1:2","3:5","6:8"],      ["0:9","10:19","20:29"]],   [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [3e-5]], {}),
        "ScECALBarrel": (["ECalBarrelScHitsEven", "ECalBarrelScHitsOdd"],   [["*"],["1","2","3","4","5"], ["*"],                        ["0:9","10:19","20:29"]],   [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [3e-5]], {}), 
        "RPCHCalEndcap": (["HCalEndcapRPCHits"],                            [["*"],["*"],                 ["0:3","4:7","8:11","12:15"], ["0:15","16:31","32:48"]],  [[1000, 20], [300, 2e-6],  [100, 2e-5], [1000, 2e-5], [250, 250], [100, 500], [1000, 500], [3e-6]], {}),
        "RPCHCalBarrel": (["HCalBarrelRPCHits"],                            [["*"],["*"],                 ["*"],                        ["0:15","16:31","32:48"]],  [[1000, 20], [300, 2e-6],  [100, 2e-5], [1000, 2e-5], [250, 250], [100, 500], [1000, 500], [3e-6]], {"complex_sad": ["0:79", "80:159", "160:234"]}), 
        "RPCHCalECRing": (["HCalECRingRPCHits"],                            [["*"],["*"],                 ["*"],                        ["*"]],                     [[1000, 20], [300, 2e-6],  [100, 2e-5], [1000, 2e-5], [250, 250], [100, 500], [1000, 500], [3e-5]], {}),         
        "ScHCalEndcap": (["HcalEndcapsCollection"],                         [["*"],["*"],                 ["0:3","4:7","8:11","12:15"], ["0:15","16:31","32:48"]],  [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [3e-4]], {}),
        "ScHcalBarrel": (["HcalBarrelRegCollection"],                       [["*"],["*"],                 ["*"],                        ["0:15","16:31","32:48"]],  [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [3e-4]], {"complex_happy" :["0:29", "30:59", "60:76"]}), 
        "ScHCalECRing": (["HcalEndcapRingCollection"],                      [["*"],["*"],                 ["*"],                        ["*"]],                     [[1000, 20], [300, 0.001], [100, 0.01], [1000, 0.01], [250, 250], [100, 500], [1000, 500], [3e-4]], {})                 
        }
...
for system in systems:
    ...
    for function in functions_list:
        histograms_to_select[system][function] = {"time":True, "lower_scale_energy":True, "upper_scale_energy": True, "all_scale_energy":True, "scaled_upper_scale_energy": True, "scaled_all_scale_energy":True, "low_#Nhits": True, "high_#Nhits": True, "all_#Nhits":True}
...
if __name__ == "__main__":
    ...
    all_histograms_dicts = execute_parallel_processing(dictionary_of_system, systems, collections, function_dict, system_functions, mip, histograms_to_select, slcio_file_list, ev_start_list, ev_stop_list, energy_threshold)
